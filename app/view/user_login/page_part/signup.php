...
<main class="form-signin">
  <form action="<?php echo BASE_URL."user_login_page_controller_class/insert_xml_function"; ?>"  method="post">
    <h1 class="h3 mb-3 fw-normal">Sing Up Form</h1>
	...
	<div class="form-floating mb-3">
      <input type="number" class="form-control" id="floatingInput" placeholder="" name="mobile">
