...
<?php
if(isset($job_cat)){
	foreach($job_cat as $cat_key => $cat_value){
?>	
					  ...
					  <li class="list-group-item d-flex justify-content-between align-items-start">
							<div class="ms-2 me-auto">
							  	<div class="fw-bold" style="padding-left:10px;">
									<i class="<?php echo $cat_value['font_awesome']; ?> mr-2"></i>
								  	<a href="<?php echo BASE_URL."job_blog_cntr/category_post_function/&cat_id=".$cat_value['id'];?>"><?php echo $cat_value['name']; ?>
									</a>
								</div>
							</div>
