...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="index.html"><?php echo "Total ".$pagenation." Result"; ?></a></h1>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
				    <img style="width:134px; height:130px;  background-color:white; box-shadow: 1px 1px 2px black,0px 0px 25px green,0px 0px 7px blue;" class="profile-image mb-3 rounded-circle mx-auto" src="app/view/job_blog/assets/images/images.jfif" alt="image" >			
...
<?php
if(isset($send_search_result)){
	foreach($send_search_result as $key => $value){
?>
			    <div class="item mb-5">
				    <div class="media">
...
if($pagenation != 0){
	echo "<li class='page-item'><a class='page-link' href='".BASE_URL."job_blog_cntr/job_search_method/&keyword=".$keyword."&page=1&start=0&item=".$item."'>First</a></li>";
}
if($page >= $cunt){
	for($i=$cunt;$i<=$limit;$i++){
		...
		echo "<li class='page-item'><a class='page-link' href='".BASE_URL."job_blog_cntr/job_search_method/&keyword=".$keyword."&page=".$i."&start=".$start."&item=".$item."'>".$i."</a></li>";
		if($i == $page){
			break;
		}
	}   
...
if($pagenation != 0){
	echo "<li class='page-item'><a class='page-link' href='".BASE_URL."job_blog_cntr/job_search_method/&keyword=".$keyword."&page=".$page."&start=".$start."&item=".$item."'>last</a></li>"; 
}
