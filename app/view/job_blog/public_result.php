...
?>
        ...
        <tr>
            ...
            <td>
				<?php 
					if(cookie::get('name') == $value['name']){
						echo "<b style='color:red'>".$value['name']."</b>";
					}else{
						echo $value['name'];
					}					  
				?>
			</td>
			<td><?php echo $value['total_sum']; ?></td>
            <td><?php echo format::onlyDate($value['date']); ?></td>
            <td>
				<?php 
					if(session::id() == $value['session_id']){
						echo "<b style='color:red'>".$value['session_id']."</b>";
					}else{
