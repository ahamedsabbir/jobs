...
<?php
if(session::get('exam_result') != null){
		...
		<section class="">
			<div class="container">
				<div class="result_div">
					<h1><?php echo ucfirst(cookie::get('name')); ?>,</h1>
					<h1>Your Got <span style="color:red;"><?php echo $result;?></span> Markes Out Of <span style="color:green;">50.</span></h1>	
<?php
    if($result < 16){
        echo "<h1>Oh No Your Are<span style='color:red;'> Fail</span>. Try Again Latter For Batter Luck.</h1>";
    }elseif($result == 17){
         echo "<h1>hm Your Are<span style='color:green;'> Pass</span>. But keep Tring For Batter Result.</h1>";
    }else{
        echo "<h1>Your Are<span style='color:green;'> Pass</span>. keep Tring You Will Get A Good Job.</h1>";
    }
?>
				</div>
			</div>
...
<?php if(session::get('right_answer') != null){	?>	
		<section>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<table class="table table-bordered">
							<tr>
								...
								<th style='text-align:center'>Answere</th>
							</tr>
<?php
	foreach(session::get('right_answer') as $key => $value){
